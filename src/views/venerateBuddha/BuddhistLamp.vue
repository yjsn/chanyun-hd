    ...
    <div class="other-main">
      ...
      <div class="other-background">
        <div class="other-content">
          <div class="input-box">
            <p class="input-box-title">供奉佛灯</p>
            <form>
              ...
              <div class="input-box-row">
                ...
                <select v-model="data.meritsProductId" class="my-select">
                  <option value="" disabled selected style="display:none;">请选择灯型</option>
...
<script>
import { addApplyMerits, getBodhisatvvaList, getTempleList, getLampList } from '@/api/index'
export default {
  name: 'BuddhistLamp',
  data() {
    return {
  ...
  methods: {
    ...
    choosedTemple() {
      ...
      getLampList({ id: this.data.templeId }).then(res => {
